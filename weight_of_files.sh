...
echo "Скрипту необходимо передать 2 параметра: 1 - путь к каталогу, 2 - максимальный размер файла в байтах."
...
if [[ $# -ne 2 ]]; then
 ...
 echo "Для работы: в первом параметре укажиме путь к каталогу, а вторым максимальный размер файла в байтах."
 exit 1
fi
